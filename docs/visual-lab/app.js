...
function getKeywordRole(value) {
  ...
  if (text.includes("client") || text.includes("browser") || text.includes("postman") || text.includes("user")) return "client";
  ...
  if (text.includes("api") || text.includes("endpoint") || text.includes("route") || text.includes("controller")) return "api";
  if (text.includes("json")) return "json";
  if (text.includes("data") || text.includes("body") || text.includes("payload")) return "data";
  if (text.includes("db") || text.includes("database") || text.includes("repository") || text.includes("storage") || text.includes("file") || text.includes("git")) return "db";
