...
실습을 마친 뒤에는 체크리스트를 보며 직접 실행한 내용을 다시 설명합니다.
이 브랜치에는 정답 자료나 비교 브랜치 안내를 싣지 않습니다.

<details>
<summary>멘토용 진행 포인트</summary>

- 요청 도구를 먼저 실행하게 하고, 실패하면 method, URL, body 순서로 확인하게 합니다.
- Git 명령은 암기보다 현재 작업 위치와 현재 branch를 설명하는 데 초점을 둡니다.
- DB 용어는 정의를 외우게 하기보다 회원 표 예시에서 row와 column을 직접 짚게 합니다.
